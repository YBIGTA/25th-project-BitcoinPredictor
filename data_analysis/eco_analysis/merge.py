...
class CryptoAndMarketDataCollector:
    ...
    def update_and_save(self):
        self.update_data()  # Update the data
        self.save_to_csv()  # Save the data to CSV
        self.save_to_mongo()  # Save the new data to MongoDB
...
if __name__ == "__main__":
    ...
    collector.update_and_save(collector)
